...
from custom_components.seventeentrack.const import DOMAIN
...
async def test_seventeentrack_sensors(hass: HomeAssistant, mock_api: MagicMock) -> None:
    """Test sensors created for 17Track integration."""
    ...
    all_packages_sensor = hass.states.get("sensor.seventeen_track_all_packages")
